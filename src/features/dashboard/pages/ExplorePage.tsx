...
const ExplorePage = () => {
  ...
  return (
    <div className={`${gradientBg} flex flex-col items-center pt-5 pb-2`}>
      <div className="mb-2 ml-2 p-1 flex items-center justify-start w-full max-w-2xl">
        <button
          className="text-purple-600 p-1 bg-transparent rounded hover:bg-purple-100 transition"
      ...
      <div className="w-full max-w-2xl mx-auto mb-5 px-2 text-center">
        ...
        <p className="text-lg text-gray-600 mb-6">
          Already staying? Explore and switch to another PG that fits your vibe!
        </p>
        ...
        <div className="w-full max-w-4xl mx-auto px-4">
          <div className="flex flex-col items-center w-full">
            <div className="w-full md:max-w-2xl">
              <h2 className="text-xl font-bold mb-1 text-purple-700 flex items-center gap-2">
            ...
            {sortedResults.length > 0 ? (
              <div className="flex flex-col items-center gap-2 w-full">
                {sortedResults.map((property) => (
                  <div className="w-full md:max-w-2xl" key={property._id}>
